...
const HeroDomicilies = () => {
    ...
    return (
        <motion.div initial="hidden" whileInView="visible" variants={animation} className='absolute top-1/2 -translate-y-1/2 left-0 items-center justify-start gap-28 bg-muted text-muted-foreground py-10 pr-20 pl-4 border border-border rounded-tr-full rounded-br-full hidden md:flex'>
